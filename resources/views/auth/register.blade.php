<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <div class="mt-2 flex gap-4">
                <label class="flex items-center">
                    <input type="radio" name="role" value="pasien" @checked(old('role') == 'pasien' || !old('role')) class="rounded">
                    <span class="ms-2 text-sm text-gray-600">Pasien</span>
                </label>
                <label class="flex items-center">
                    <input type="radio" name="role" value="dokter" @checked(old('role') == 'dokter') class="rounded">
                    <span class="ms-2 text-sm text-gray-600">Dokter</span>
                </label>
            </div>
        ...
        <!-- Birthdate (Optional) -->
        <div class="mt-4">
            <x-input-label for="birthdate" :value="__('Birthdate (Optional)')" />
